#Generic file that can be used by all Consul server instances. This configures all instances to use the same ports and thus requires use of a docker bridge network so each instance has a different IP
...
#ca_file                    = "/etc/consul.d/ca_cert.pem"
#cert_file                  = "/etc/consul.d/consul_cert.pem"
#key_file                   = "/etc/consul.d/consul_key.pem"